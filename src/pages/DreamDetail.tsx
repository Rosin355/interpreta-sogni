  ...
  const handleGenerateImage = async (style?: string) => {
    ...
    try {
      ...
      const errorMessage = mapImageErrorCode(
        errBody?.errorCode,
        errBody?.error || errBody?.message || error?.message || "Si è verificato un errore imprevisto durante la generazione",
        errBody?.details
      );
              ...
              <section className="space-y-3 border-t border-border/60 pt-6">
                    ...
                    if (error) {
                      ...
                      toast({
                        ...
                        description: value === "public" 
                          ? "Il tuo sogno è ora pubblico e visibile nella pagina Community" 
                ...
                <p className="text-xs text-muted-foreground">
                  {dream.visibility === "public"
                    ? "Questo sogno è visibile a tutti gli utenti nella pagina Community"
